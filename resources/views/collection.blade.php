...
<head>
    <meta charset="utf-8" />
    <title>Project Listing | Adminto - Responsive Admin Dashboard Template</title>
    ...
    <!-- App css -->
    <link href="./css/config/default/bootstrap.min.css" rel="stylesheet" type="text/css"
        id="bs-default-stylesheet" />
    <link href="./css/config/default/app.min.css" rel="stylesheet" type="text/css"
        id="app-default-stylesheet" />

    <link href="./css/config/default/bootstrap-dark.min.css" rel="stylesheet" type="text/css"
                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                <div class="card-body project-box">
                                    <div class="badge bg-success float-end">{{ "Popular Collection" }}</div>
                                    <h4 class="mt-0"><a href="" class="text-dark">{{ $val->name }}</a></h4>
                                    <p class="text-success text-uppercase font-13">{{ $val->symbol }}</p>
                                    <p class="text-muted font-13">{{ \Illuminate\Support\Str::limit($val->description, 150, $end='...') }}<a href="#"
                                            class="text-primary">View more</a>
                                    </p>

                                    <ul class="list-inline">
                                        <li class="list-inline-item me-4">
                                            <h4 class="mb-0">{{ $val->totalItems ?? "0" }}</h4>
                                    ...
                                    <h5>Recomendation <span class="text-success float-end">80%</span></h5>
