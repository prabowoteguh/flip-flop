    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left mb-0">
                ...
                <li>
                    <h4 class="page-title-main">All Collections</h4>
                </li>
                        ...
                        <div class="row portfolioContainer">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 natural personal">
                                <div class="gal-detail thumb">
                                    <a href="{{ $val->image ? $val->image : URL::to('/')."/nft.png" }}" class="image-popup" title="Screenshot-1">
                                        <img src="{{ $val->image ? $val->image : URL::to('/')."/nft.png" }}" class="thumb-img img-fluid"
                                            alt="work-thumbnail">
                                    </a>

                                    <div class="text-center">
                                        <h4>{{ $val->name }}</h4>
                                        <p class="font-13 text-muted mb-2">{{ $val->symbol }}</p>
