    ...
    public function run()
    {
        ...
        $description = array(
            ...
            1 => array(
                'name' => 'Lil Foxy',
                'symbol' => 'lil_foxy',
                'description' => 'Lil Foxy are a collection of 2222 Lil Foxy NFTs and 1111 $FCF ( Foxy Coin Flip ). You are welcome to join our community and ride the wave with us.',
                'assets' => array(
            ...
            10 => array(
                'name' => 'CatchKing',
                'symbol' => 'catchking',
                'description' => 'Welcome to Catchtopia: a constantly evolving gameplay universe. Play as Catch, a fearless explorer on a mission to collect everything under the sun in this exciting new take on the collect-a-thon and rogue-lite genres. The game merges the relaxing, casual, atmospheric gameplay typical of collect-a-thons with the thrilling combat that puts you on the edge of your seat in rogue-lites. Fill out your collection log and progress through the game as you fight through dungeons of fierce enemies, gather resources through harvesting, scavenging, and fishing! Make friends with other players, collect adorable pets, trade with other players on an open marketplace, and even battle your pets against other players!',
                'assets' => array(
            ...
            16 => array(
                ...
                'description' => 'Solana-based. Community-based. NFT-based. LFG-based. WAGMI-based platform. Welcome to the Danger Valley!',
                'assets' => array(
        ...
        We are establishing partnerships and collaborations to get the whole Sol NFT space together.',
            ...
            30 => array(
                ...
                'description' => 'The half-light wars have torn mankind asunder. All that remains are fragments of the old age. Pilgrims, you are bequeathed to traverse this forsaken land. Trust in your instincts; seek refuge in The Sanctuary; respect the order of the High Table; surrender your faith and belief unto The $EYE; muster as much resources as you can and become Chosen. And maybe, you too may live to see the dawn of this new age.',
                'assets' => array(
        ...
        ',
            ...
            127 => array(
                ...
                'description' => 'The DEA Dogs have been corrupted by the mobsters. A Solana NFT project that brings digital art to the next level.',
                'assets' => array(
        ...
        $attributes = array(
            array("name"=>"Liberty Square: The Sinister Squirrel Syndicate","totalSupply"=>"9999","totalVolume"=>"26,772.87","totalFloor"=>"16","totalOwners"=>"3,185"),
            array("name"=>"Primates","totalSupply"=>"10000","totalVolume"=>"309,396.44","totalFloor"=>"15","totalOwners"=>"5,088"),
            array("name"=>"AI Degens","totalSupply"=>"3333","totalVolume"=>"22,424.20","totalFloor"=>"6","totalOwners"=>"724"),
            array("name"=>"Okay Bears","totalSupply"=>"10000","totalVolume"=>"1,908,911.49","totalFloor"=>"95","totalOwners"=>"5,597"),
            array("name"=>"Gothic Degens ","totalSupply"=>"4448","totalVolume"=>"51,598.74","totalFloor"=>"16","totalOwners"=>"1,910"),
            array("name"=>"Weeping Angels","totalSupply"=>"4444","totalVolume"=>"12,243.25","totalFloor"=>"2","totalOwners"=>"1,336"),
            array("name"=>"DeGods","totalSupply"=>"10000","totalVolume"=>"756,390.14","totalFloor"=>"249","totalOwners"=>"4,320"),
            array("name"=>"Crashfaces","totalSupply"=>"1000","totalVolume"=>"10,973.94","totalFloor"=>"49","totalOwners"=>"303"),
            array("name"=>"Reptilian Renegade (Lizards)","totalSupply"=>"4000","totalVolume"=>"164,487.76","totalFloor"=>"8","totalOwners"=>"3,601"),
            array("name"=>"Quantum Traders","totalSupply"=>"8900","totalVolume"=>"138,235.78","totalFloor"=>"5","totalOwners"=>"8,145"),
            array("name"=>"The Resurrected","totalSupply"=>"4300","totalVolume"=>"10,573.93","totalFloor"=>"4","totalOwners"=>"2,002"),
            array("name"=>"Masked Ape DAO","totalSupply"=>"4400","totalVolume"=>"7,578.50","totalFloor"=>"2","totalOwners"=>"1,382"),
            array("name"=>"Eternal Dragons: Genesis","totalSupply"=>"1000","totalVolume"=>"6,810.04","totalFloor"=>"8","totalOwners"=>"774"),
            array("name"=>"CETS ON CRECK","totalSupply"=>"6969","totalVolume"=>"344,872.71","totalFloor"=>"44","totalOwners"=>"4,211"),
            array("name"=>"DegenTown","totalSupply"=>"8000","totalVolume"=>"89,450.25","totalFloor"=>"4","totalOwners"=>"1,615"),
            array("name"=>"Solana Monkey Business","totalSupply"=>"5000","totalVolume"=>"1,145,381.77","totalFloor"=>"195","totalOwners"=>"2,780"),
            array("name"=>"DreamersNFT","totalSupply"=>"5600","totalVolume"=>"5,293.13","totalFloor"=>"1","totalOwners"=>"1,917"),
            array("name"=>"SOLcrash","totalSupply"=>"1290","totalVolume"=>"6,625.57","totalFloor"=>"5","totalOwners"=>"478"),
            array("name"=>"Degenerate Ape Academy","totalSupply"=>"10009","totalVolume"=>"1,319,284.03","totalFloor"=>"51","totalOwners"=>"4,553"),
            array("name"=>"Blocksmith Labs","totalSupply"=>"4444","totalVolume"=>"234,113.72","totalFloor"=>"51","totalOwners"=>"2,727"),
            array("name"=>"Shadowy Super Coder DAO","totalSupply"=>"10000","totalVolume"=>"367,536.02","totalFloor"=>"114","totalOwners"=>"172"),
            array("name"=>"Pokerfaces","totalSupply"=>"377","totalVolume"=>"18,548.08","totalFloor"=>"190","totalOwners"=>"111"),
            array("name"=>"Son of a PaPe","totalSupply"=>"4444","totalVolume"=>"7,918.88","totalFloor"=>"1","totalOwners"=>"729"),
            array("name"=>"Saint Degen","totalSupply"=>"5555","totalVolume"=>"11,495.70","totalFloor"=>"2","totalOwners"=>"1,701"),
            array("name"=>"Degen Coin Flip","totalSupply"=>"555","totalVolume"=>"46,461.68","totalFloor"=>"489","totalOwners"=>"219"),
            array("name"=>"Netrunner","totalSupply"=>"4600","totalVolume"=>"13,345.57","totalFloor"=>"3","totalOwners"=>"1,978"),
            array("name"=>"SolStein","totalSupply"=>"2200","totalVolume"=>"32,696.05","totalFloor"=>"8","totalOwners"=>"1,936"),
            array("name"=>"Trippin' Ape Tribe","totalSupply"=>"10000","totalVolume"=>"486,673.00","totalFloor"=>"12","totalOwners"=>"9,542"),
            array("name"=>"MOO DAO","totalSupply"=>"3300","totalVolume"=>"2,962.48","totalFloor"=>"1","totalOwners"=>"830"),
            array("name"=>"Shrouded Playground","totalSupply"=>"7800","totalVolume"=>"9,626.63","totalFloor"=>"1","totalOwners"=>"2,489"),
            array("name"=>"The Nobunagas","totalSupply"=>"6969","totalVolume"=>"2,834.97","totalFloor"=>"1","totalOwners"=>"1,262"),
            array("name"=>"Famous Fox Federation","totalSupply"=>"7800","totalVolume"=>"209,417.19","totalFloor"=>"25","totalOwners"=>"4,250"),
            array("name"=>"Blood Bats","totalSupply"=>"3300","totalVolume"=>"4,325.44","totalFloor"=>"1","totalOwners"=>"781"),
            array("name"=>"Cyber Pharmacists","totalSupply"=>"10000","totalVolume"=>"30,443.21","totalFloor"=>"1","totalOwners"=>"2,934"),
            array("name"=>"Just Ape.","totalSupply"=>"10000","totalVolume"=>"184,542.52","totalFloor"=>"4","totalOwners"=>"5,011"),
            array("name"=>"Communi3: Mad Scientists","totalSupply"=>"5000","totalVolume"=>"206,583.60","totalFloor"=>"27","totalOwners"=>"2,801"),
            array("name"=>"DucksVegas","totalSupply"=>"4000","totalVolume"=>"4,361.16","totalFloor"=>"1","totalOwners"=>"1,867"),
            array("name"=>"Udder Chaos","totalSupply"=>"6666","totalVolume"=>"60,636.10","totalFloor"=>"3","totalOwners"=>"2,975"),
            array("name"=>"Infected Mob","totalSupply"=>"7800","totalVolume"=>"17,337.85","totalFloor"=>"1","totalOwners"=>"2,676"),
            array("name"=>"Flippies","totalSupply"=>"10000","totalVolume"=>"5,171.49","totalFloor"=>"2","totalOwners"=>"4,069"),
            array("name"=>"SolGoths","totalSupply"=>"2500","totalVolume"=>"2,366.36","totalFloor"=>"1","totalOwners"=>"95"),
            array("name"=>"Bubblegoose Ballers","totalSupply"=>"10000","totalVolume"=>"82,112.74","totalFloor"=>"8","totalOwners"=>"3,427"),
            array("name"=>"Sacred Dao","totalSupply"=>"5500","totalVolume"=>"2,753.48","totalFloor"=>"1","totalOwners"=>"1,585"),
            array("name"=>"GGSG: Galactic Geckos","totalSupply"=>"10000","totalVolume"=>"385,380.03","totalFloor"=>"11","totalOwners"=>"3,295"),
            array("name"=>"GhostKidDAO","totalSupply"=>"5000","totalVolume"=>"81,580.73","totalFloor"=>"7","totalOwners"=>"3,061"),
            array("name"=>"Elysian Kids ","totalSupply"=>"3300","totalVolume"=>"3,380.14","totalFloor"=>"1","totalOwners"=>"1,386"),
            array("name"=>"Jelly Rascals","totalSupply"=>"6700","totalVolume"=>"12,911.71","totalFloor"=>"9","totalOwners"=>"1,366"),
            array("name"=>"Baked Berserk","totalSupply"=>"4700","totalVolume"=>"2,339.45","totalFloor"=>"1","totalOwners"=>"837"),
            array("name"=>"Genesis Genopet Habitats","totalSupply"=>"3977","totalVolume"=>"125,779.76","totalFloor"=>"40","totalOwners"=>"3,310"),
            array("name"=>"Stoned Ape Crew","totalSupply"=>"4200","totalVolume"=>"178,499.40","totalFloor"=>"27","totalOwners"=>"4,102"),
            array("name"=>"Fabulosa","totalSupply"=>"1100","totalVolume"=>"1,808.00","totalFloor"=>"1","totalOwners"=>"674"),
            array("name"=>"Bohemia","totalSupply"=>"5000","totalVolume"=>"107,263.52","totalFloor"=>"8","totalOwners"=>"2,533"),
            array("name"=>"CatchKing Explorers","totalSupply"=>"5600","totalVolume"=>"24,046.06","totalFloor"=>"1","totalOwners"=>"1,859"),
            array("name"=>"CatchKing Items","totalSupply"=>"7600","totalVolume"=>"84.92","totalFloor"=>"1","totalOwners"=>"799"),
            array("name"=>"Nekoverse NekoPet","totalSupply"=>"3200","totalVolume"=>"183.64","totalFloor"=>"1","totalOwners"=>"1,548"),
            array("name"=>"PLANE-X","totalSupply"=>"3300","totalVolume"=>"179.47","totalFloor"=>"1","totalOwners"=>"893"),
            array("name"=>"Danger Valley Ducks","totalSupply"=>"7800","totalVolume"=>"67,752.97","totalFloor"=>"1","totalOwners"=>"2,818"),
            array("name"=>"Birds Aren't Real","totalSupply"=>"2200","totalVolume"=>"615.37","totalFloor"=>"1","totalOwners"=>"737"),
            array("name"=>"Bored Ape Solana Club","totalSupply"=>"6000","totalVolume"=>"137,468.17","totalFloor"=>"10","totalOwners"=>"2,451"),
            array("name"=>"The Lion Cats","totalSupply"=>"799","totalVolume"=>"25,584.44","totalFloor"=>"3","totalOwners"=>"563"),
            array("name"=>"Wonky Wolves","totalSupply"=>"5600","totalVolume"=>"1,253.82","totalFloor"=>"1","totalOwners"=>"803"),
            array("name"=>"Cool Kidz Society","totalSupply"=>"2200","totalVolume"=>"7,726.86","totalFloor"=>"1","totalOwners"=>"1,234"),
            array("name"=>"Project Tenjin","totalSupply"=>"7500","totalVolume"=>"39,202.11","totalFloor"=>"2","totalOwners"=>"6,333"),
            array("name"=>"Bull Empire","totalSupply"=>"2500","totalVolume"=>"41,481.95","totalFloor"=>"2","totalOwners"=>"2,018"),
            ...
            array("name"=>"Nekoverse: Origin Quad","totalSupply"=>"10000","totalVolume"=>"18,405.85","totalFloor"=>"1","totalOwners"=>"2,053"),
            array("name"=>"Caveworld","totalSupply"=>"8900","totalVolume"=>"6,899.22","totalFloor"=>"3","totalOwners"=>"2,868"),
            array("name"=>"The Stoned Frogs","totalSupply"=>"8400","totalVolume"=>"78,851.20","totalFloor"=>"3","totalOwners"=>"4,507"),
            ...
            array("name"=>"Bounty Hunter Space Guild","totalSupply"=>"5600","totalVolume"=>"12,513.72","totalFloor"=>"3","totalOwners"=>"1,661"),
            array("name"=>"Sniping Demons","totalSupply"=>"1700","totalVolume"=>"975.45","totalFloor"=>"1","totalOwners"=>"201"),
            array("name"=>"Genesis Collection","totalSupply"=>"5500","totalVolume"=>"8,572.51","totalFloor"=>"4","totalOwners"=>"47"),
            array("name"=>"Honeyland Pass","totalSupply"=>"300","totalVolume"=>"1,491.34","totalFloor"=>"7","totalOwners"=>"177"),
            ...
            array("name"=>"Dahlys","totalSupply"=>"2200","totalVolume"=>"18,819.60","totalFloor"=>"1","totalOwners"=>"2,043"),
            array("name"=>"Dahly Dream Mushrooms","totalSupply"=>"2000","totalVolume"=>"79.87","totalFloor"=>"1","totalOwners"=>"843"),
            array("name"=>"First Verse","totalSupply"=>"5600","totalVolume"=>"17,501.21","totalFloor"=>"3","totalOwners"=>"1,741"),
            ...
            array("name"=>"Taiyo Robotics","totalSupply"=>"2100","totalVolume"=>"133,030.00","totalFloor"=>"120","totalOwners"=>"1,065"),
            array("name"=>"Taiyo Infants/Incubators","totalSupply"=>"1500","totalVolume"=>"53,914.73","totalFloor"=>"40","totalOwners"=>"1,035"),
            array("name"=>"Taiyo Oil","totalSupply"=>"3600","totalVolume"=>"11,889.17","totalFloor"=>"14","totalOwners"=>"980"),
            array("name"=>"Taiyo Armory parts","totalSupply"=>"630","totalVolume"=>"501.89","totalFloor"=>"4","totalOwners"=>"52"),
            array("name"=>"Solful Creatures","totalSupply"=>"4400","totalVolume"=>"30,709.20","totalFloor"=>"2","totalOwners"=>"2,654"),
            array("name"=>"Solful Divinity","totalSupply"=>"444","totalVolume"=>"647.66","totalFloor"=>"8","totalOwners"=>"272"),
            array("name"=>"Goats Gang","totalSupply"=>"2200","totalVolume"=>"827.76","totalFloor"=>"1","totalOwners"=>"1,632"),
            ...
            array("name"=>"Nezumi Badges","totalSupply"=>"7800","totalVolume"=>"570.44","totalFloor"=>"1","totalOwners"=>"1,533"),
            array("name"=>"Domesticated Humans","totalSupply"=>"574","totalVolume"=>"5.42","totalFloor"=>"1","totalOwners"=>"47"),
            array("name"=>"GhostKidDAO Potions","totalSupply"=>"5100","totalVolume"=>"688.29","totalFloor"=>"1","totalOwners"=>"2,274"),
            array("name"=>"Gothic Ghosts","totalSupply"=>"2000","totalVolume"=>"4,118.44","totalFloor"=>"3","totalOwners"=>"1,478"),
            ...
            array("name"=>"UNLOCK DEFI - GOLDEN TICKETS","totalSupply"=>"13100","totalVolume"=>"18,314.47","totalFloor"=>"1","totalOwners"=>"5,974"),
            array("name"=>"Bounty Hunter Space Guild Cache","totalSupply"=>"8500","totalVolume"=>"730.11","totalFloor"=>"1","totalOwners"=>"891"),
            array("name"=>"Bounty Hunter Space Guild","totalSupply"=>"5600","totalVolume"=>"12,513.72","totalFloor"=>"3","totalOwners"=>"1,660"),
            array("name"=>"Bounty Hunter Space Guild Starfighters","totalSupply"=>"1300","totalVolume"=>"23.63","totalFloor"=>"1","totalOwners"=>"431"),
            array("name"=>"22105: Voyagers","totalSupply"=>"5600","totalVolume"=>"3,520.80","totalFloor"=>"1","totalOwners"=>"1,541"),
            array("name"=>"Turtles","totalSupply"=>"3300","totalVolume"=>"81,859.00","totalFloor"=>"5","totalOwners"=>"1,507"),
            array("name"=>"Turtles Potion","totalSupply"=>"1700","totalVolume"=>"46.56","totalFloor"=>"1","totalOwners"=>"492"),
            array("name"=>"The Lost Apes","totalSupply"=>"4000","totalVolume"=>"22,771.54","totalFloor"=>"1","totalOwners"=>"1,219"),
            ...
            array("name"=>"FunGuyz","totalSupply"=>"3000","totalVolume"=>"23,039.50","totalFloor"=>"1","totalOwners"=>"1,665"),
            array("name"=>"Fungies","totalSupply"=>"1500","totalVolume"=>"1,061.83","totalFloor"=>"1","totalOwners"=>"1,140"),
            array("name"=>"ArtMonkees","totalSupply"=>"5000","totalVolume"=>"9,575.17","totalFloor"=>"1","totalOwners"=>"2,114"),
            array("name"=>"Kalisten Early Adopters","totalSupply"=>"1000","totalVolume"=>"4,106.44","totalFloor"=>"3","totalOwners"=>"230"),
            ...
            array("name"=>"Gyris Genesis Bura","totalSupply"=>"2700","totalVolume"=>"1,128.66","totalFloor"=>"1","totalOwners"=>"657"),
            array("name"=>"Gyris Genesis Oggs","totalSupply"=>"2200","totalVolume"=>"79.59","totalFloor"=>"1","totalOwners"=>"480"),
            array("name"=>"AGE of SAM","totalSupply"=>"4400","totalVolume"=>"7,245.38","totalFloor"=>"2","totalOwners"=>"1,050"),
            array("name"=>"DARKNESS","totalSupply"=>"1100","totalVolume"=>"151.92","totalFloor"=>"1","totalOwners"=>"229"),
            array("name"=>"Draygon Investment Co","totalSupply"=>"888","totalVolume"=>"3,817.18","totalFloor"=>"1","totalOwners"=>"128"),
            ...
            array("name"=>"SOLhouse","totalSupply"=>"550","totalVolume"=>"9,399.34","totalFloor"=>"6","totalOwners"=>"230"),
            array("name"=>"SOLcrash","totalSupply"=>"1300","totalVolume"=>"7,013.20","totalFloor"=>"5","totalOwners"=>"458"),
            array("name"=>"Danger Valley Ducks","totalSupply"=>"7800","totalVolume"=>"67,760.47","totalFloor"=>"1","totalOwners"=>"2,823"),
            ...
            array("name"=>"Baked Bots","totalSupply"=>"2400","totalVolume"=>"11,368.24","totalFloor"=>"2","totalOwners"=>"1,029"),
            array("name"=>"Baby Bots","totalSupply"=>"1200","totalVolume"=>"55.35","totalFloor"=>"1","totalOwners"=>"457"),
            array("name"=>"The Big Five","totalSupply"=>"1300","totalVolume"=>"7,626.46","totalFloor"=>"2","totalOwners"=>"363"),
            array("name"=>"Hana's Trinkets","totalSupply"=>"315","totalVolume"=>"8.51","totalFloor"=>"1","totalOwners"=>"234"),
            array("name"=>"Stranded Unicorns","totalSupply"=>"13700","totalVolume"=>"1,069.93","totalFloor"=>"1","totalOwners"=>"6,107"),
            array("name"=>"Solana Surfers","totalSupply"=>"4400","totalVolume"=>"4,077.75","totalFloor"=>"1","totalOwners"=>"1,102"),
            array("name"=>"The Glitterflies","totalSupply"=>"777","totalVolume"=>"2,726.66","totalFloor"=>"1","totalOwners"=>"474"),
            array("name"=>"Folktales of Lunaria","totalSupply"=>"10000","totalVolume"=>"12,367.12","totalFloor"=>"1","totalOwners"=>"3,924"),
            array("name"=>"Santa Miners","totalSupply"=>"2100","totalVolume"=>"1,620.57","totalFloor"=>"3","totalOwners"=>"827"),
            array("name"=>"Psyker - Keycards","totalSupply"=>"7000","totalVolume"=>"4,077.68","totalFloor"=>"1","totalOwners"=>"2,417"),
            array("name"=>"Psyker - Hideouts","totalSupply"=>"3500","totalVolume"=>"193.51","totalFloor"=>"1","totalOwners"=>"368"),
            array("name"=>"Boryoku Dragonz","totalSupply"=>"1100","totalVolume"=>"154,890.12","totalFloor"=>"60","totalOwners"=>"559"),
            array("name"=>"Boryoku Baby Dragonz","totalSupply"=>"1200","totalVolume"=>"45,362.04","totalFloor"=>"6","totalOwners"=>"751"),
            array("name"=>"Chorles's Sacraments: Spores","totalSupply"=>"10000","totalVolume"=>"16,620.53","totalFloor"=>"1","totalOwners"=>"8,607"),
            array("name"=>"Chorles's Sacraments: Mushrooms","totalSupply"=>"19700","totalVolume"=>"248.62","totalFloor"=>"1","totalOwners"=>"2,723"),
            array("name"=>"Creamy Friends","totalSupply"=>"5600","totalVolume"=>"14,392.63","totalFloor"=>"1","totalOwners"=>"2,655"),
            array("name"=>"CryptoCream","totalSupply"=>"600","totalVolume"=>"3,778.43","totalFloor"=>"5","totalOwners"=>"488"),
            array("name"=>"NaimitsuAI","totalSupply"=>"1000","totalVolume"=>"1,022.78","totalFloor"=>"1","totalOwners"=>"613"),
            array("name"=>"Magnum AI","totalSupply"=>"3900","totalVolume"=>"25,375.60","totalFloor"=>"13","totalOwners"=>"0.69"),
            array("name"=>"CoolCatsDao","totalSupply"=>"5600","totalVolume"=>"1,292.37","totalFloor"=>"1","totalOwners"=>"1,220"),
            array("name"=>"Thugbirdz","totalSupply"=>"3300","totalVolume"=>"225,343.45","totalFloor"=>"13","totalOwners"=>"2,302"),
            array("name"=>"ThugMonkez","totalSupply"=>"6700","totalVolume"=>"8,419.97","totalFloor"=>"1","totalOwners"=>"4,806"),
            array("name"=>"Cloak Demons","totalSupply"=>"5600","totalVolume"=>"4,591.51","totalFloor"=>"1","totalOwners"=>"1,511"),
            array("name"=>"ArtPunks","totalSupply"=>"10000","totalVolume"=>"20,350.22","totalFloor"=>"2","totalOwners"=>"2,003"),
            array("name"=>"Secret Llama Agency","totalSupply"=>"3000","totalVolume"=>"243.97","totalFloor"=>"1","totalOwners"=>"827"),
            array("name"=>"Balloonsville","totalSupply"=>"5000","totalVolume"=>"62,582.34","totalFloor"=>"1","totalOwners"=>"1,369"),
            ...
            array("name"=>"Bushido Society","totalSupply"=>"2200","totalVolume"=>"13,898.51","totalFloor"=>"1","totalOwners"=>"1,018"),
            array("name"=>"Yaku Engineering ONI-S01","totalSupply"=>"7000","totalVolume"=>"63,901.92","totalFloor"=>"1","totalOwners"=>"3,726"),
            array("name"=>"Yaku | Capsule X","totalSupply"=>"7200","totalVolume"=>"49,076.55","totalFloor"=>"3","totalOwners"=>"3,629"),
            array("name"=>"Smoke Heads","totalSupply"=>"4400","totalVolume"=>"93,494.14","totalFloor"=>"3","totalOwners"=>"1,831"),
            array("name"=>"Suteki","totalSupply"=>"6000","totalVolume"=>"36,630.77","totalFloor"=>"1","totalOwners"=>"3,017"),
            array("name"=>"Saiba Gang","totalSupply"=>"3300","totalVolume"=>"1,285.98","totalFloor"=>"1","totalOwners"=>"1,248"),
            array("name"=>"Saiba Gang Collectibles","totalSupply"=>"59","totalVolume"=>"2.93","totalFloor"=>"2","totalOwners"=>"37"),
            array("name"=>"Decimus Dynamics","totalSupply"=>"4000","totalVolume"=>"37,957.74","totalFloor"=>"1","totalOwners"=>"3,662"),
            array("name"=>"Yoked Yetis","totalSupply"=>"3300","totalVolume"=>"5,211.35","totalFloor"=>"1","totalOwners"=>"471"),
            array("name"=>"Sol Kitties","totalSupply"=>"2600","totalVolume"=>"4,437.91","totalFloor"=>"1","totalOwners"=>"481"),
            array("name"=>"3D Sol Kitties","totalSupply"=>"2700","totalVolume"=>"1,772.37","totalFloor"=>"1","totalOwners"=>"621"),
            ...
            array("name"=>"Dãku Reapers Resurrection","totalSupply"=>"889","totalVolume"=>"19,035.49","totalFloor"=>"1","totalOwners"=>"204"),
            array("name"=>"Underworld Lions","totalSupply"=>"958","totalVolume"=>"9,842.75","totalFloor"=>"1","totalOwners"=>"442"),
            array("name"=>"Eternal Underworld Potions","totalSupply"=>"888","totalVolume"=>"26.08","totalFloor"=>"1","totalOwners"=>"28"),
            array("name"=>"Doge Track: Genesis Doges","totalSupply"=>"3300","totalVolume"=>"6,970.70","totalFloor"=>"1","totalOwners"=>"953"),
            array("name"=>"Doge Track: Genesis Tracks","totalSupply"=>"333","totalVolume"=>"687.42","totalFloor"=>"5","totalOwners"=>"181"),
            array("name"=>"CyberHeroez","totalSupply"=>"2200","totalVolume"=>"1,701.44","totalFloor"=>"1","totalOwners"=>"1,182"),
            array("name"=>"CyberVillainz","totalSupply"=>"1000","totalVolume"=>"8,929.96","totalFloor"=>"4","totalOwners"=>"678"),
            array("name"=>"DeFi Pirates","totalSupply"=>"10000","totalVolume"=>"103,107.48","totalFloor"=>"1","totalOwners"=>"3,496"),
            array("name"=>"TombStoned High Society","totalSupply"=>"6700","totalVolume"=>"158,416.99","totalFloor"=>"3","totalOwners"=>"2,532"),
            array("name"=>"TombStoned Skulls","totalSupply"=>"5600","totalVolume"=>"8,341.83","totalFloor"=>"1","totalOwners"=>"1,266"),
            array("name"=>"Zenjin Viperz","totalSupply"=>"2000","totalVolume"=>"23,367.07","totalFloor"=>"2","totalOwners"=>"1,723"),
            array("name"=>"Zenjin Bottle","totalSupply"=>"2000","totalVolume"=>"980.62","totalFloor"=>"1","totalOwners"=>"1,088"),
            ...
            array("name"=>"Serum Surfers","totalSupply"=>"214","totalVolume"=>"15,483.51","totalFloor"=>"2","totalOwners"=>"88"),
            array("name"=>"Notifish","totalSupply"=>"3300","totalVolume"=>"9,187.53","totalFloor"=>"2","totalOwners"=>"1,196"),
            array("name"=>"Orc Racing Club","totalSupply"=>"6800","totalVolume"=>"1,712.02","totalFloor"=>"2","totalOwners"=>"2,129"),
            array("name"=>"ORCars","totalSupply"=>"7000","totalVolume"=>"153.27","totalFloor"=>"1","totalOwners"=>"1,983"),
            array("name"=>"Matrica Labs: Pixels","totalSupply"=>"4400","totalVolume"=>"23,010.73","totalFloor"=>"8","totalOwners"=>"1,433"),
            array("name"=>"Matrica Labs: Corrupted","totalSupply"=>"333","totalVolume"=>"1,593.89","totalFloor"=>"10","totalOwners"=>"184"),
            array("name"=>"SolRarity - Rarikeys","totalSupply"=>"2600","totalVolume"=>"59,528.09","totalFloor"=>"11","totalOwners"=>"2.289"),
            ...
            array("name"=>"Nova Pass","totalSupply"=>"4800","totalVolume"=>"675.03","totalFloor"=>"1","totalOwners"=>"3,952"),
            array("name"=>"Solana Money Boys","totalSupply"=>"4400","totalVolume"=>"53,606.36","totalFloor"=>"8","totalOwners"=>"1,911"),
            array("name"=>"Solana Money Girls","totalSupply"=>"2200","totalVolume"=>"7,100.63","totalFloor"=>"6","totalOwners"=>"921"),
            array("name"=>"Solana Diamond Boys","totalSupply"=>"2200","totalVolume"=>"7,919.53","totalFloor"=>"2","totalOwners"=>"1,082"),
            array("name"=>"Zero G Labs: Solanauts","totalSupply"=>"500","totalVolume"=>"4,111.56","totalFloor"=>"5","totalOwners"=>"4.97"),
            ...
            array("name"=>"Cyber Samurai Tensei Collection","totalSupply"=>"5000","totalVolume"=>"3,744.43","totalFloor"=>"5","totalOwners"=>"855"),
            ...
            array("name"=>"Blockasset Legends","totalSupply"=>"10000","totalVolume"=>"24,300.76","totalFloor"=>"3","totalOwners"=>"2,340"),
            array("name"=>"Smesh Bros","totalSupply"=>"4000","totalVolume"=>"6,298.12","totalFloor"=>"3","totalOwners"=>"1,412"),
            array("name"=>"Mootators","totalSupply"=>"1200","totalVolume"=>"1,135.69","totalFloor"=>"1","totalOwners"=>"621"),
            array("name"=>"Detown","totalSupply"=>"733","totalVolume"=>"198.24","totalFloor"=>"1","totalOwners"=>"248"),
            array("name"=>"Guardians of Kyoudai","totalSupply"=>"888","totalVolume"=>"5,079.27","totalFloor"=>"2","totalOwners"=>"298"),
            array("name"=>"Kyoudai Spirits","totalSupply"=>"4400","totalVolume"=>"1,493.21","totalFloor"=>"1","totalOwners"=>"1,266"),
            array("name"=>"Pet Solciety Founder Petizens","totalSupply"=>"2900","totalVolume"=>"798.58","totalFloor"=>"1","totalOwners"=>"972"),
            array("name"=>"Visionary Studios - Genesis Membership","totalSupply"=>"777","totalVolume"=>"19,706.18","totalFloor"=>"20","totalOwners"=>"442"),
            array("name"=>"Soulofox","totalSupply"=>"2200","totalVolume"=>"9,121.34","totalFloor"=>"3","totalOwners"=>"763"),
            array("name"=>"Jagoe's Foodie Frens","totalSupply"=>"202","totalVolume"=>"2,740.78","totalFloor"=>"4","totalOwners"=>"155"),
            array("name"=>"Visionary Studios | Year One - Commemorative","totalSupply"=>"4200","totalVolume"=>"653.78","totalFloor"=>"1","totalOwners"=>"1,925"),
            array("name"=>"Collectorz Club: The Collectorz","totalSupply"=>"444","totalVolume"=>"434.8","totalFloor"=>"6","totalOwners"=>"155"),
            array("name"=>"Vandal City","totalSupply"=>"10000","totalVolume"=>"55,033.30","totalFloor"=>"3","totalOwners"=>"5,596"),
            array("name"=>"Robo Cocks","totalSupply"=>"3800","totalVolume"=>"16,131.23","totalFloor"=>"1","totalOwners"=>"979"),
            array("name"=>"Fortis Cocks","totalSupply"=>"1300","totalVolume"=>"137.08","totalFloor"=>"2","totalOwners"=>"239"),
            array("name"=>"CryptoCubs","totalSupply"=>"10000","totalVolume"=>"17,257.59","totalFloor"=>"1","totalOwners"=>"1,776"),
            array("name"=>"Pitbull Poker Tour","totalSupply"=>"4400","totalVolume"=>"8,586.59","totalFloor"=>"2","totalOwners"=>"864"),
            ...
            array("name"=>"Moshiheads","totalSupply"=>"3000","totalVolume"=>"25,672.44","totalFloor"=>"1","totalOwners"=>"864"),
            array("name"=>"Moshi Armor","totalSupply"=>"86","totalVolume"=>"48.23","totalFloor"=>"4","totalOwners"=>"11"),
            array("name"=>"Zankoku Cybogrez","totalSupply"=>"1100","totalVolume"=>"11,887.82","totalFloor"=>"2","totalOwners"=>"483"),
            array("name"=>"Zankoku Fairyz","totalSupply"=>"1100","totalVolume"=>"9,502.90","totalFloor"=>"2","totalOwners"=>"204"),
            ...
            array("name"=>"Zankoku Arcanistz","totalSupply"=>"4400","totalVolume"=>"1,490.01","totalFloor"=>"3","totalOwners"=>"912"),
            array("name"=>"Arc Flasks","totalSupply"=>"1500","totalVolume"=>"32.19","totalFloor"=>"2","totalOwners"=>"436"),
            array("name"=>"Pesky Penguins","totalSupply"=>"8900","totalVolume"=>"138,022.35","totalFloor"=>"5","totalOwners"=>"4,134"),
            array("name"=>"Hyper-Dimensional Noot Juice","totalSupply"=>"2200","totalVolume"=>"229.02","totalFloor"=>"2","totalOwners"=>"464"),
            array("name"=>"Burrito Boyz","totalSupply"=>"10000","totalVolume"=>"14,159.45","totalFloor"=>"1","totalOwners"=>"3,042"),
            array("name"=>"DYOR NERDS","totalSupply"=>"5600","totalVolume"=>"27,834.93","totalFloor"=>"2","totalOwners"=>"5,116"),
            array("name"=>"Gemmy","totalSupply"=>"5000","totalVolume"=>"48,660.70","totalFloor"=>"2","totalOwners"=>"1,747"),
            array("name"=>"Tiny Dogz","totalSupply"=>"695","totalVolume"=>"3,659.88","totalFloor"=>"1","totalOwners"=>"86"),
            array("name"=>"Tiny Pupz","totalSupply"=>"333","totalVolume"=>"911.11","totalFloor"=>"1","totalOwners"=>"22"),
            array("name"=>"Tiny Colonies","totalSupply"=>"11500","totalVolume"=>"6,555.96","totalFloor"=>"1","totalOwners"=>"3,020"),
            array("name"=>"Tiny Colony Characters","totalSupply"=>"5500","totalVolume"=>"2,246.18","totalFloor"=>"2","totalOwners"=>"1,361"),
            array("name"=>"Degenerate Ape Academy","totalSupply"=>"10000","totalVolume"=>"1,319,759.43","totalFloor"=>"50","totalOwners"=>"4,561"),
            array("name"=>"Degenerate Ape Kindergarten","totalSupply"=>"2500","totalVolume"=>"70,922.64","totalFloor"=>"63","totalOwners"=>"1,021"),
            array("name"=>"GORILLAE GANG","totalSupply"=>"4000","totalVolume"=>"5,618.27","totalFloor"=>"10","totalOwners"=>"973"),
            array("name"=>"Carton Kids","totalSupply"=>"2000","totalVolume"=>"12,068.42","totalFloor"=>"1","totalOwners"=>"500"),
            array("name"=>"Ghost Guys | By Metaforge","totalSupply"=>"2000","totalVolume"=>"11,281.75","totalFloor"=>"1","totalOwners"=>"1,333"),
            array("name"=>"Ghost Boys","totalSupply"=>"350","totalVolume"=>"428.38","totalFloor"=>"1","totalOwners"=>"241"),
            array("name"=>"Solsteads Surreal Estate","totalSupply"=>"2500","totalVolume"=>"158,915.07","totalFloor"=>"19","totalOwners"=>"1,476"),
            array("name"=>"Citizens by Solsteads","totalSupply"=>"13699","totalVolume"=>"71,090.16","totalFloor"=>"2","totalOwners"=>"5,789"),
            array("name"=>"Mindfolk","totalSupply"=>"768","totalVolume"=>"52,409.46","totalFloor"=>"9","totalOwners"=>"337"),
            array("name"=>"Mindfolk Cabins","totalSupply"=>"444","totalVolume"=>"4,065.77","totalFloor"=>"4","totalOwners"=>"175"),
            array("name"=>"Mindfolk - Dukes of Folktown","totalSupply"=>"573","totalVolume"=>"3,182.56","totalFloor"=>"1","totalOwners"=>"206"),
            array("name"=>"Mindfolk Boats","totalSupply"=>"222","totalVolume"=>"2,871.68","totalFloor"=>"11","totalOwners"=>"114"),
            array("name"=>"Mindfolk Mindlings","totalSupply"=>"5000","totalVolume"=>"6,376.93","totalFloor"=>"1","totalOwners"=>"500"),
            array("name"=>"Mindfolk Pirates","totalSupply"=>"666","totalVolume"=>"9,551.85","totalFloor"=>"3","totalOwners"=>"356"),
            array("name"=>"Bulldog Billionaires","totalSupply"=>"2000","totalVolume"=>"27,391.21","totalFloor"=>"2","totalOwners"=>"1,610"),
            ...
            array("name"=>"Male HODL Whales","totalSupply"=>"3000","totalVolume"=>"28,500.26","totalFloor"=>"1","totalOwners"=>"998"),
            array("name"=>"Female HODL Whales","totalSupply"=>"1500","totalVolume"=>"8,195.43","totalFloor"=>"1","totalOwners"=>"393"),
            array("name"=>"Baby HODL Whales","totalSupply"=>"750","totalVolume"=>"526.59","totalFloor"=>"2","totalOwners"=>"162"),
            array("name"=>"Pot Heads","totalSupply"=>"1400","totalVolume"=>"4,423.50","totalFloor"=>"1","totalOwners"=>"135"),
            array("name"=>"Pot Heads: Lvl 1 Plant Food","totalSupply"=>"392","totalVolume"=>"163.09","totalFloor"=>"3","totalOwners"=>"87"),
            array("name"=>"Bot Head","totalSupply"=>"2400","totalVolume"=>"27,929.86","totalFloor"=>"6","totalOwners"=>"1,300"),
            array("name"=>"Amoebits!","totalSupply"=>"1800","totalVolume"=>"248.82","totalFloor"=>"2","totalOwners"=>"560"),
            array("name"=>"Xin Dragons","totalSupply"=>"887","totalVolume"=>"11,001.87","totalFloor"=>"27","totalOwners"=>"370"),
            array("name"=>"Xin Dragons Gen 2","totalSupply"=>"2700","totalVolume"=>"8,803.29","totalFloor"=>"5","totalOwners"=>"621"),
            array("name"=>"Lost Pirates","totalSupply"=>"5600","totalVolume"=>"2,605.13","totalFloor"=>"1","totalOwners"=>"1,325"),
            array("name"=>"Oasis Civilization","totalSupply"=>"3300","totalVolume"=>"22,895.97","totalFloor"=>"1","totalOwners"=>"1,426"),
            array("name"=>"Mile High Ape Club","totalSupply"=>"6200","totalVolume"=>"20,740.37","totalFloor"=>"2","totalOwners"=>"1,938"),
            array("name"=>"Mile High Ape Club: JET A Serum","totalSupply"=>"2200","totalVolume"=>"377.55","totalFloor"=>"1","totalOwners"=>"488"),
            array("name"=>"Panic Station Pythons","totalSupply"=>"4400","totalVolume"=>"8,013.49","totalFloor"=>"2","totalOwners"=>"1,424"),
            array("name"=>"Dumplies","totalSupply"=>"2500","totalVolume"=>"2,284.37","totalFloor"=>"1","totalOwners"=>"630"),
            array("name"=>"OG Atadians","totalSupply"=>"5000","totalVolume"=>"124,475.82","totalFloor"=>"15","totalOwners"=>"2,518"),
            array("name"=>"LUX | Entertainment","totalSupply"=>"5000","totalVolume"=>"9,390.39","totalFloor"=>"3","totalOwners"=>"1,276"),
            array("name"=>"LuxAI","totalSupply"=>"5000","totalVolume"=>"9,419.84","totalFloor"=>"2","totalOwners"=>"1,168"),
            array("name"=>"LUX | Real Estate","totalSupply"=>"5000","totalVolume"=>"97,035.05","totalFloor"=>"2","totalOwners"=>"2,672"),
            array("name"=>"MoonBears","totalSupply"=>"4400","totalVolume"=>"21,587.06","totalFloor"=>"2","totalOwners"=>"2,247"),
            array("name"=>"Aurory","totalSupply"=>"10000","totalVolume"=>"342,894.05","totalFloor"=>"35","totalOwners"=>"3,196"),
            array("name"=>"InvokersElves","totalSupply"=>"5000","totalVolume"=>"1,991.25","totalFloor"=>"1","totalOwners"=>"506"),
            array("name"=>"Flavor Flamez","totalSupply"=>"3300","totalVolume"=>"9,490.71","totalFloor"=>"1","totalOwners"=>"1,289"),
            array("name"=>"Dragon Scale Flame","totalSupply"=>"127","totalVolume"=>"15.63","totalFloor"=>"2","totalOwners"=>"54"),
            array("name"=>"Miners of Mars","totalSupply"=>"7000","totalVolume"=>"32,198.49","totalFloor"=>"1","totalOwners"=>"6,427"),
            array("name"=>"Solana Miners","totalSupply"=>"1100","totalVolume"=>"7,862.05","totalFloor"=>"1","totalOwners"=>"492"),
            array("name"=>"Hidden Boyz","totalSupply"=>"1600","totalVolume"=>"8,729.53","totalFloor"=>"1","totalOwners"=>"858"),
            array("name"=>"MonkeLabs","totalSupply"=>"3000","totalVolume"=>"106,700.54","totalFloor"=>"3","totalOwners"=>"1,258"),
            array("name"=>"MonkeLabs DAO","totalSupply"=>"6000","totalVolume"=>"13,619.91","totalFloor"=>"2","totalOwners"=>"2,824"),
            array("name"=>"6 RINGS","totalSupply"=>"50000","totalVolume"=>"32,236.58","totalFloor"=>"2","totalOwners"=>"2,016"),
            array("name"=>"MekaGorillaz","totalSupply"=>"913","totalVolume"=>"7,433.99","totalFloor"=>"1","totalOwners"=>"100"),
            array("name"=>"Kamakura","totalSupply"=>"3300","totalVolume"=>"12,873.20","totalFloor"=>"1","totalOwners"=>"1,176"),
            array("name"=>"CyberWave","totalSupply"=>"8900","totalVolume"=>"4,901.12","totalFloor"=>"1","totalOwners"=>"2,238"),
            array("name"=>"OG Women","totalSupply"=>"777","totalVolume"=>"4,338.91","totalFloor"=>"1","totalOwners"=>"308"),
            array("name"=>"Reptilian Renegade (Lizard Eyes)","totalSupply"=>"3700","totalVolume"=>"10,632.56","totalFloor"=>"1","totalOwners"=>"2,755"),
            array("name"=>"Eyes Gen 2","totalSupply"=>"2500","totalVolume"=>"1,308.99","totalFloor"=>"2","totalOwners"=>"1,361"),
            array("name"=>"MellowMen","totalSupply"=>"2200","totalVolume"=>"14,816.35","totalFloor"=>"3","totalOwners"=>"1,092"),
            array("name"=>"Minute Men","totalSupply"=>"7000","totalVolume"=>"6,783.21","totalFloor"=>"4","totalOwners"=>"2,236"),
            array("name"=>"Digital Minute Men","totalSupply"=>"3500","totalVolume"=>"161.19","totalFloor"=>"2","totalOwners"=>"808"),
            array("name"=>"The Pilgrims","totalSupply"=>"2000","totalVolume"=>"5,143.52","totalFloor"=>"1","totalOwners"=>"938"),
            array("name"=>"Book of The All-Seeing","totalSupply"=>"2000","totalVolume"=>"78.68","totalFloor"=>"1","totalOwners"=>"523"),
            array("name"=>"Melt Labs","totalSupply"=>"2500","totalVolume"=>"15,798.74","totalFloor"=>"1","totalOwners"=>"1,475"),
            ...
            array("name"=>"Gamerooms","totalSupply"=>"6700","totalVolume"=>"10,669.84","totalFloor"=>"18","totalOwners"=>"828"),
            array("name"=>"PixelShoes | Air Jordan 4","totalSupply"=>"67","totalVolume"=>"3.2","totalFloor"=>"1","totalOwners"=>"22"),
            array("name"=>"The Orcs","totalSupply"=>"8900","totalVolume"=>"69,209.99","totalFloor"=>"2","totalOwners"=>"3,047"),
            array("name"=>"GGSG: Enigma Crystals","totalSupply"=>"2600","totalVolume"=>"17,621.47","totalFloor"=>"14","totalOwners"=>"1,225"),
            array("name"=>"GGSG: Concordians","totalSupply"=>"4100","totalVolume"=>"4,515.35","totalFloor"=>"1","totalOwners"=>"1,464"),
            array("name"=>"Magic Mushies","totalSupply"=>"4400","totalVolume"=>"13,072.23","totalFloor"=>"1","totalOwners"=>"1,377"),
            array("name"=>"Mythic Mushies","totalSupply"=>"666","totalVolume"=>"254.83","totalFloor"=>"1","totalOwners"=>"229"),
            array("name"=>"SolCraft Dwarf Miners","totalSupply"=>"2000","totalVolume"=>"3,090.70","totalFloor"=>"4","totalOwners"=>"114"),
            array("name"=>"SolCraft Battle Animals","totalSupply"=>"2000","totalVolume"=>"422.48","totalFloor"=>"1","totalOwners"=>"1,746"),
            ...
            array("name"=>"UwDegens","totalSupply"=>"4100","totalVolume"=>"1,674.12","totalFloor"=>"1","totalOwners"=>"1,033"),
            array("name"=>"DegenGoddess","totalSupply"=>"5000","totalVolume"=>"3,341.53","totalFloor"=>"1","totalOwners"=>"1,340"),
            array("name"=>"Degenerate Trash Pandas","totalSupply"=>"17100","totalVolume"=>"131,584.04","totalFloor"=>"5","totalOwners"=>"6,212"),
            array("name"=>"Degenerate Holiday Pandas","totalSupply"=>"14800","totalVolume"=>"355.53","totalFloor"=>"14","totalOwners"=>"14,727"),
            array("name"=>"DTP Dumpsters","totalSupply"=>"1900","totalVolume"=>"4,114.16","totalFloor"=>"3","totalOwners"=>"1,095"),
            array("name"=>"Pit's Trash Bin","totalSupply"=>"2000","totalVolume"=>"1,349.76","totalFloor"=>"1","totalOwners"=>"518"),
            array("name"=>"Trashy Cakes","totalSupply"=>"1400","totalVolume"=>"619.26","totalFloor"=>"1","totalOwners"=>"776"),
            array("name"=>"Degen Trash Pandas Shovels","totalSupply"=>"500","totalVolume"=>"1,246.89","totalFloor"=>"3","totalOwners"=>"237"),
            array("name"=>"Best Buds","totalSupply"=>"4200","totalVolume"=>"69,811.55","totalFloor"=>"3","totalOwners"=>"2,852"),
            array("name"=>"Galactic Goons","totalSupply"=>"3000","totalVolume"=>"372.43","totalFloor"=>"1","totalOwners"=>"707"),
            array("name"=>"Jikan Studios","totalSupply"=>"8900","totalVolume"=>"58,947.12","totalFloor"=>"1","totalOwners"=>"8,277"),
            array("name"=>"Infinity Labs","totalSupply"=>"8900","totalVolume"=>"67,569.60","totalFloor"=>"1","totalOwners"=>"2,305"),
            array("name"=>"Cosmic Condos","totalSupply"=>"3300","totalVolume"=>"14,884.92","totalFloor"=>"1","totalOwners"=>"1,412"),
            array("name"=>"Cosmic Condos (Gen 2)","totalSupply"=>"4200","totalVolume"=>"210.14","totalFloor"=>"1","totalOwners"=>"711"),
            array("name"=>"Wise Cats","totalSupply"=>"3900","totalVolume"=>"15,072.25","totalFloor"=>"1","totalOwners"=>"718"),
            array("name"=>"Junkiez","totalSupply"=>"3500","totalVolume"=>"30,409.60","totalFloor"=>"1","totalOwners"=>"1,884"),
            array("name"=>"777 Junkies","totalSupply"=>"777","totalVolume"=>"1,707.40","totalFloor"=>"1","totalOwners"=>"318"),
            array("name"=>"The Anon Club™","totalSupply"=>"888","totalVolume"=>"29,982.00","totalFloor"=>"35","totalOwners"=>"518"),
            array("name"=>"Anonymous Goons","totalSupply"=>"269","totalVolume"=>"0.28","totalFloor"=>"1","totalOwners"=>"73"),
            array("name"=>"Pen Frens","totalSupply"=>"2200","totalVolume"=>"8,981.59","totalFloor"=>"3","totalOwners"=>"715"),
            array("name"=>"Kirin Kingdom","totalSupply"=>"3000","totalVolume"=>"21,955.03","totalFloor"=>"1","totalOwners"=>"1,603"),
            array("name"=>"Kirin Kingdom Babies","totalSupply"=>"587","totalVolume"=>"174.16","totalFloor"=>"1","totalOwners"=>"269"),
            array("name"=>"Teddy TRex","totalSupply"=>"5000","totalVolume"=>"4,252.29","totalFloor"=>"1","totalOwners"=>"1,111"),
            array("name"=>"Cartoon Cartel","totalSupply"=>"10000","totalVolume"=>"7,300.11","totalFloor"=>"1","totalOwners"=>"3,371"),
            array("name"=>"DIAMOND TOWN HEADS","totalSupply"=>"5000","totalVolume"=>"26,156.35","totalFloor"=>"1","totalOwners"=>"1,642"),
            array("name"=>"Diamond Town Heads Shampoo","totalSupply"=>"5000","totalVolume"=>"1,055.63","totalFloor"=>"1","totalOwners"=>"1,680"),
            array("name"=>"Diamond Town Residence","totalSupply"=>"1500","totalVolume"=>"234.67","totalFloor"=>"1","totalOwners"=>"454"),
            array("name"=>"BR1: Genesis Apes","totalSupply"=>"2500","totalVolume"=>"10,345.35","totalFloor"=>"6","totalOwners"=>"758"),
            array("name"=>"BR1: Droid Operatives","totalSupply"=>"7500","totalVolume"=>"5,624.08","totalFloor"=>"2","totalOwners"=>"1,533"),
            array("name"=>"Nuked Apes","totalSupply"=>"3900","totalVolume"=>"91,050.27","totalFloor"=>"8","totalOwners"=>"3,622"),
            array("name"=>"Crashfaces","totalSupply"=>"1000","totalVolume"=>"13,664.18","totalFloor"=>"36","totalOwners"=>"309"),
            array("name"=>"Moonly","totalSupply"=>"4500","totalVolume"=>"42,867.34","totalFloor"=>"2","totalOwners"=>"3,008"),
            array("name"=>"Robot Factory Works","totalSupply"=>"4400","totalVolume"=>"2,471.80","totalFloor"=>"1","totalOwners"=>"1,031"),
            array("name"=>"Rox Collective - Season One","totalSupply"=>"6000","totalVolume"=>"26,615.15","totalFloor"=>"1","totalOwners"=>"2,150"),
            array("name"=>"Rox Collective - Season Two","totalSupply"=>"718","totalVolume"=>"72.43","totalFloor"=>"1","totalOwners"=>"290"),
            array("name"=>"Desolates Metaverse","totalSupply"=>"6700","totalVolume"=>"45,216.01","totalFloor"=>"2","totalOwners"=>"3,333"),
            array("name"=>"Shukutai Dinos","totalSupply"=>"878","totalVolume"=>"4,248.06","totalFloor"=>"1","totalOwners"=>"405"),
            array("name"=>"Mrbot","totalSupply"=>"1100","totalVolume"=>"3,942.36","totalFloor"=>"1","totalOwners"=>"695"),
            array("name"=>"MrbotV2","totalSupply"=>"400","totalVolume"=>"46.43","totalFloor"=>"1","totalOwners"=>"220"),
            array("name"=>"Skeleton Crew Skulls","totalSupply"=>"6700","totalVolume"=>"21,724.52","totalFloor"=>"1","totalOwners"=>"2,613"),
            ...
            array("name"=>"SOLtoolsXYZ","totalSupply"=>"555","totalVolume"=>"3,124.75","totalFloor"=>"2","totalOwners"=>"459"),
            array("name"=>"Xapes Lab","totalSupply"=>"1400","totalVolume"=>"5,029.53","totalFloor"=>"1","totalOwners"=>"457"),
            ...
            array("name"=>"Solana Monke Rejects","totalSupply"=>"6000","totalVolume"=>"58,558.29","totalFloor"=>"3","totalOwners"=>"2,758"),
            array("name"=>"Portals","totalSupply"=>"5000","totalVolume"=>"277,849.89","totalFloor"=>"28","totalOwners"=>"2,929"),
            array("name"=>"Portals Genesis Citizen Cards","totalSupply"=>"10000","totalVolume"=>"19,588.36","totalFloor"=>"3","totalOwners"=>"3,821"),
            array("name"=>"Portals Standard Citizen Cards","totalSupply"=>"35000","totalVolume"=>"4,037.05","totalFloor"=>"1","totalOwners"=>"5,509"),
            array("name"=>"DazedDucks Metagalactic Club","totalSupply"=>"10000","totalVolume"=>"112,523.21","totalFloor"=>"3","totalOwners"=>"3,596"),
            ...
            array("name"=>"HaLo Flip","totalSupply"=>"777","totalVolume"=>"4,115.72","totalFloor"=>"4","totalOwners"=>"514"),
            array("name"=>"Hana's Trinkets","totalSupply"=>"315","totalVolume"=>"8.51","totalFloor"=>"1","totalOwners"=>"234"),
            ...
            array("name"=>"SickBoys","totalSupply"=>"4400","totalVolume"=>"6,977.36","totalFloor"=>"1","totalOwners"=>"1,442"),
            array("name"=>"Rude Golems","totalSupply"=>"8900","totalVolume"=>"45,281.89","totalFloor"=>"4","totalOwners"=>"3,663"),
            array("name"=>"Rude Demons","totalSupply"=>"2400","totalVolume"=>"12,298.63","totalFloor"=>"9","totalOwners"=>"1,533"),
            array("name"=>"Power Orbs","totalSupply"=>"9400","totalVolume"=>"11,076.08","totalFloor"=>"1","totalOwners"=>"949"),
            array("name"=>"SharkBros","totalSupply"=>"6600","totalVolume"=>"411.42","totalFloor"=>"1","totalOwners"=>"1,571"),
            array("name"=>"Custom SharkBros","totalSupply"=>"1600","totalVolume"=>"47.05","totalFloor"=>"1","totalOwners"=>"661"),
            array("name"=>"Duckish","totalSupply"=>"3300","totalVolume"=>"1,240.35","totalFloor"=>"2","totalOwners"=>"1,015"),
            ...
            array("name"=>"The Glitterflies","totalSupply"=>"777","totalVolume"=>"2,728.96","totalFloor"=>"1","totalOwners"=>"474"),
            array("name"=>"Ehecatl Dragons","totalSupply"=>"1100","totalVolume"=>"2,781.83","totalFloor"=>"1","totalOwners"=>"425"),
            ...
            array("name"=>"Bunnies N Homies Club","totalSupply"=>"7600","totalVolume"=>"53,238.83","totalFloor"=>"1","totalOwners"=>"3,310"),
            ...
            array("name"=>"Monsta Scientist","totalSupply"=>"4400","totalVolume"=>"8,151.61","totalFloor"=>"1","totalOwners"=>"2,149"),
            array("name"=>"Flippin' Rabbits","totalSupply"=>"3300","totalVolume"=>"2,226.19","totalFloor"=>"2","totalOwners"=>"1,275"),
            array("name"=>"Honey Badges","totalSupply"=>"2200","totalVolume"=>"213.06","totalFloor"=>"1","totalOwners"=>"815"),
            array("name"=>"Santa Miners","totalSupply"=>"2100","totalVolume"=>"1,622.72","totalFloor"=>"2","totalOwners"=>"828"),
        );;

        foreach ($attributes as $attribute) {
            $attr = Collection::updateOrCreate(['name' => $attribute['name']], $attribute);
        }
    }
}
